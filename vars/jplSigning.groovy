...
def call(cfg, String signingRepository, String signingPath, String artifactPath) {
    ...
    sh "ci-scripts/.jpl-scripts/bin/signApk.sh --sdkVersion='jpl-android:${cfg.projectName}' --signingRepository='${signingRepository}' --signingPath=${signingPath}  --artifactPath='${artifactPath}'"
}
